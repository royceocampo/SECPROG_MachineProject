...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="col-lg-2">
				...
				<h3>${owner.firstname} ${owner.lastname} <br>
				...
				${owner.college} ${owner.idnum}<br>
				${owner.gender}<br>
				${owner.email}
				</h3>
				<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modalComposeFeed">Leave Feedback</button>
				<br><br>
				<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modalComposeMsg">Contact Owner</button>
			</div>
			<div class="col-lg-2">
			</div>
			<div class="col-lg-8">
	...
	<div class="modal fade" id="modalComposeFeed">
      <div class="modal-dialog">
        ...
        <form action="FeedbackServlet" method="POST">
	          ...
	          <div class="modal-body">
	            	<div>
	            		<label class="col-sm-12" for="inputBody">Feedback</label>
	                  <div class="col-sm-12">
	                  	<input type="number" name="rating" placeholder="Rate from 1 to 5" />
	                  	<textarea class="form-control" id="inputBody" rows="17" name="msg"></textarea>
	                  </div>
	            	</div>
	          </div>
	          <input type="hidden" id="ownerName" name="ownerName" value="${owner.username}"></input>
	...
	<div class="modal fade" id="modalComposeMsg">
      <div class="modal-dialog">
        <div class="modal-content">
        <form action="MessageServlet" method="POST">
			  ...
			  <div class="modal-body">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-10"><input type="text" class="form-control" id="inputSubject" placeholder="subject" name="subject"></div>
					</div>
					<div class="form-group">
					  <label class="col-sm-12" for="inputBody">Message</label>
					  <div class="col-sm-12"><textarea class="form-control" id="inputBody" rows="18" name="content"></textarea></div>
					</div>
